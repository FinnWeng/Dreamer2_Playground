...
if __name__ == "__main__":
    ...
    play_process = dreamer_play.Play(wrapped_gym, Dreamer, config, training= False)
    ...
    while True:
        ...
        """
        play_process.play_for_fun(using_random_policy=False, must_be_whole_episode=False)
